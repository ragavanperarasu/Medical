...
const initialPatients = [
  ...
  { id: 4, name: "Elena Gilbert", dob: "05-11-1995", regno: "MRN004", complaint: "Ankle Sprain", doctor: "Dr. Brown", status: "New" },
];
  ...
  return (
    ...
    <Navbar/>
      ...
      <Container maxWidth="md" sx={{mt: 4, pb: 4}}>
        {/* Header Section */}
        <Box sx={{ mb: 4 }}>
          <Typography variant="h4" sx={{ fontWeight: 700, color: '#1A2027', mb: 1, fontFamily:'Comfortaa' }}>
            Patient Directory
          </Typography>
              ...
              <Grid size={{ xs: 12, md: 12 }} key={patient.id} >
                ...
                >
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <Box sx={{ display: 'flex', gap: 2 }}>
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', mt: 0.5, fontFamily:'Philosopher' }}>
                          {patient.regno}
                        </Typography>
                      </Box>
                    </Box>
                  ...
                  <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr 1fr' }, gap: 2, mt: 3 }}>
                    <Box>
                      <Typography variant="caption" display="block" color="text.secondary" gutterBottom sx={{fontFamily:'Comfortaa'}}>DATE OF BIRTH</Typography>
                    ...
                    <Box>
                      <Typography variant="caption" display="block" color="text.secondary" gutterBottom sx={{fontFamily:'Comfortaa'}}>CHIEF COMPLAINT</Typography>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Box>
                      <Typography variant="caption" display="block" color="text.secondary" gutterBottom sx={{fontFamily:'Comfortaa'}}>ATTENDING DOCTOR</Typography>
                      <Chip 
                        label={patient.doctor} 
                        size="small" 
                        sx={{ bgcolor: '#ecf4fd', fontWeight: 600, color: '#475569', fontFamily:'Philosopher' }} 
                      />
                    </Box>
                  </Box>
                </Paper>
