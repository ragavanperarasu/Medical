    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          SO PREVIOUS CONVERSATION SOME QUESTIONS WERE ASKED BY LLM, SO CONTINUE TO ASK QUESTIONS BASED ON THE NEW CONVERSATION AND PREVIOUS SUMMARY. IF THE PREVIOUS SUMMARY SOME QUESTIONS WERE NOT ANSWERED THEN ASK THOSE QUESTIONS FIRST OTHERWISE ASK NEW QUESTIONS BASED ON THE NEW CONVERSATION. ALSO IF THERE ARE ANY SUGGESTIONS FOR THE NURSE TO IMPROVE THE CARE THEN ALSO SUGGEST.
          `;
